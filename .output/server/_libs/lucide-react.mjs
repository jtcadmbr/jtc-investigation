...
const FingerprintPattern = createLucideIcon("fingerprint-pattern", __iconNode$z);
const __iconNode$y = [
  [
    "path",
    {
...
const FolderInput = createLucideIcon("folder-input", __iconNode$y);
const __iconNode$x = [
  [
    "path",
    {
...
const Link2Off = createLucideIcon("link-2-off", __iconNode$s);
const __iconNode$r = [
...
const ScanFace = createLucideIcon("scan-face", __iconNode$g);
const __iconNode$f = [
