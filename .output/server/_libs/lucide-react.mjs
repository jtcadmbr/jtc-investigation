...
const ArrowUpRight = createLucideIcon("arrow-up-right", __iconNode$1c);
const __iconNode$1b = [
  [
    "path",
    {
...
const CheckCheck = createLucideIcon("check-check", __iconNode$18);
...
const Command = createLucideIcon("command", __iconNode$11);
const __iconNode$10 = [
...
const Ear = createLucideIcon("ear", __iconNode$Z);
const __iconNode$Y = [
...
const Focus = createLucideIcon("focus", __iconNode$Q);
const __iconNode$P = [
  [
    "path",
    {
...
const FolderInput = createLucideIcon("folder-input", __iconNode$P);
const __iconNode$O = [
  [
    "path",
    {
...
const Link2Off = createLucideIcon("link-2-off", __iconNode$H);
const __iconNode$G = [
...
const Microscope = createLucideIcon("microscope", __iconNode$w);
const __iconNode$v = [
...
const PackageSearch = createLucideIcon("package-search", __iconNode$s);
const __iconNode$r = [
  ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
  ["path", { d: "M3 9h18", key: "1pudct" }],
  ["path", { d: "M9 21V9", key: "1oto5p" }]
];
const PanelsTopLeft = createLucideIcon("panels-top-left", __iconNode$r);
const __iconNode$q = [
  [
    "path",
    {
